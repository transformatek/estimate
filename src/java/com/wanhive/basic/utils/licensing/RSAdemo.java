...
//Roger Morrison
//March 14, 2002
//This applet allows a user to create RSA keys and encrypt/decrypt numbers.
// It is for educational purposes only and is not industrial strength for lots of
// reasons.  For starters is it designed by a first time Java programmer, 
// it also uses basic psuedo-random number generation.
//
...
//I'm using this main applet as the Action Listener mainly because
// I don't know how to implement it in a separate class and I gave
// up trying.  So currently I can only use buttons in the applet.
 
public class RSAdemo extends Applet implements ActionListener {
	private static final long serialVersionUID = 1L;
//I initialized the controls in the same order they appear on the page
...
// set at 20 which means the odds of being a prime is 1-2^20 or about one in a million of it being
