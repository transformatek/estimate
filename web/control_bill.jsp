...
<html>
    <head>
        ...
        <script type="text/javascript" src="script/project/control/controlBillAction.js"></script>
    </head>
    <body>
        ...
        //Initialize the first level
            initializeControlBillTable(212300, <%=request.getParameter("id") + ", " + request.getParameter("estimateId")%>);
