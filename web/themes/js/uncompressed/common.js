...
if(!window.DHTML_SUITE_THEME_FOLDER)var DHTML_SUITE_THEME_FOLDER=myServerAddress+'themes/';
if(!window.DHTML_SUITE_JS_FOLDER)var DHTML_SUITE_JS_FOLDER=myServerAddress+'themes/js/';

//alert(DHTML_SUITE_JS_FOLDER);
/************************************************************************************************************
 *
 * Global variables
 *
...
//Widget dependencies
widgetDep['basics']=['basic/ajaxpagefetcher.js','basic/localTime.js','basic/objectloader.js'];
widgetDep['menus']=['menu/contextMenu.js','menu/menuBar.js','menu/menuItem.js','menu/menuModel.js','menu/menuInit.js','menu/slideMenu.js','menu/navigator.js'];
widgetDep['windows']=['window/internalWindow.js','window/helpWindowOpener.js','window/splashScreen.js'];
widgetDep['tabs']=['menu/tabView.js','basic/dynamicContent.js','ajax.js'];
widgetDep['calendar']=['basic/calendar.js','basic/dragDropSimple.js', 'window/initCalendar.js'];
//widgetDep['modalMessage'] = ['window/modalMessage.js','basic/dynamicContent.js','basic/ajax.js','window/splashScreen.js'];
/****************************************************************/
...
// IE
	...
	//$$$MOD for ESTIMATE: Chrome bug fix
	//Modified slightly to suppress the Chrome bug which wrongfully renders
	//the context menu.
	while((el=el.offsetParent)!=null){
		...
		if(el.tagName=='BODY') {
			...
			returnValue += (el.offsetTop-Math.min(el.scrollTop,viewPort.element.scrollTop));
			if(document.all)returnValue+=el.clientTop;
			//alert(el.scrollTop+"###"+viewPort.element.scrollTop+"***"+viewPort.element.tagName);
		}
		//$$$MOD END for ESTIMATE
	} 
	return returnValue;
}
