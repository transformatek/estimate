...
//	Index of currently displayed menu model.
	var modifyMenu=null;
//	MODIFIED: Reference to function to be called before menu is displayed
	var menuBar;
...
__displayContextMenu:function(e){
	...
	//Modified to setup access permisssions
	if(ref.modifyMenu!=null)
		ref.modifyMenu();
