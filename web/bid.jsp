...
<html>
    <head>
        ...
        <script type="text/javascript" src="script/project/tender/bidAction.js"></script>
    </head>
    <body>
        ...
        //callBidderAjax(<%=request.getParameter("tenderId")%>);
            initializeBidderTable(213600, <%=request.getParameter("tenderId")%>);
        </script>
    </body>
</html>